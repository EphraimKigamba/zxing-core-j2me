 ...
 * own object.
 *
 * <p>In contrast to {@link FinderPatternFinder}, this class will return an
 * array of all possible QR code locations in the image.</p>
 *
...
final class MultiFinderPatternFinder extends FinderPatternFinder {
    ...
    private int ModuleSizeComparatorCompare(FinderPattern center1, FinderPattern center2) {
        float value = center2.getEstimatedModuleSize() - center1.getEstimatedModuleSize();
        return value < 0.0 ? -1 : value > 0.0 ? 1 : 0;
    }

    private void SortModuleSizeComparatorCompare(Vector src) {
        for (int i = 0; i < src.size(); i++) {
            if (i + 1 < src.size()) {
                FinderPattern center1 = (FinderPattern) src.elementAt(i);
                FinderPattern center2 = (FinderPattern) src.elementAt(i + 1);
                int comp = ModuleSizeComparatorCompare(center1, center2);
                if (comp == 0) {
                } else if (comp == 1) {//>
    ...
    private Vector selectMutipleBestPatterns() throws NotFoundException {
        ...
        if (size == 3) {
            ...
            Vector innerValues = new Vector();
            innerValues.addElement(possibleCenters.elementAt(0));
            innerValues.addElement(possibleCenters.elementAt(1));
            innerValues.addElement(possibleCenters.elementAt(2));
            returnValues.addElement(innerValues);
            return returnValues;
...
//                    };
        ...
        SortModuleSizeComparatorCompare(possibleCenters);
        /*
    ...
    public Vector findMulti(Hashtable hints) throws NotFoundException {
