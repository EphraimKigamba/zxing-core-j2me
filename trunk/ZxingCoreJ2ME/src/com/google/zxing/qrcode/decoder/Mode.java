...
//////  HANZI(new int[]{8, 10, 12}, 0x0D);
    public static Mode TERMINATOR = new Mode(new int[]{0, 0, 0}, 0x00); // Not really a mode...
    public static Mode NUMERIC = new Mode(new int[]{10, 12, 14}, 0x01);
    public static Mode ALPHANUMERIC = new Mode(new int[]{9, 11, 13}, 0x02);
    public static Mode STRUCTURED_APPEND = new Mode(new int[]{0, 0, 0}, 0x03); // Not supported
    public static Mode BYTE = new Mode(new int[]{8, 16, 16}, 0x04);
    public static Mode ECI = new Mode(new int[]{0, 0, 0}, 0x07); // character counts don't apply
    public static Mode KANJI = new Mode(new int[]{8, 10, 12}, 0x08);
    public static Mode FNC1_FIRST_POSITION = new Mode(new int[]{0, 0, 0}, 0x05);
    public static Mode FNC1_SECOND_POSITION = new Mode(new int[]{0, 0, 0}, 0x09);
    /**
     * See GBT 18284-2000; "Hanzi" is a transliteration of this mode name.
     */
    public static Mode HANZI = new Mode(new int[]{8, 10, 12}, 0x0D);
