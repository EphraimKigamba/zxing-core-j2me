...
/**
 * <p>Decodes Code 39 barcodes. This does not support "Full ASCII Code 39"
 * yet.</p>
 *
 * @author Sean Owen
 * @see Code93Reader
...
public final class Code39Reader extends OneDReader {
    ...
    private final StringBuffer decodeRowResult;
    ...
    public Code39Reader(boolean usingCheckDigit, boolean extendedMode) {
        ...
        decodeRowResult = new StringBuffer(20);
        counters = new int[9];
    }
...
//  @Override
    public Result decodeRow(int rowNumber, BitArray row, Hashtable hints)
        ...
        Library.fill(theCounters, 0);
        StringBuffer result = decodeRowResult;
        result.setLength(0);
