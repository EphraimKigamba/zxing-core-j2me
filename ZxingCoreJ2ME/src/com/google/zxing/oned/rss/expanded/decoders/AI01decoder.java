...
abstract class AI01decoder extends AbstractExpandedDecoder {
  ...
  protected final void encodeCompressedGtin(StringBuffer buf, int currentPos) {
    buf.append("(01)");
  ...
  protected final void encodeCompressedGtinWithoutAI(StringBuffer buf, int currentPos, int initialBufferPosition) {
    for(int i = 0; i < 4; ++i){
