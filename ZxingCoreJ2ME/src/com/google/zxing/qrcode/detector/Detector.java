...
/**
 * <p>Encapsulates logic that can detect a QR Code in an image, even if the QR
 * Code is rotated or skewed, or partially obscured.</p>
 *
 * @author Sean Owen
 */
...
//  public final DetectorResult detect(Map<DecodeHintType,?> hints) throws NotFoundException, FormatException {
    public final DetectorResult detect(Hashtable hints) throws NotFoundException, FormatException {
    ...
    /**
     * <p>Computes the dimension (number of modules on a size) of the QR Code
     ...
     * the width of each, measuring along the axis between their centers.</p>
     */
     ...
     * from the start to this point.</p>
     *
     * <p>This is used when figuring out how wide a finder pattern is, when the
     * finder pattern may be skewed or rotated.</p>
     */
