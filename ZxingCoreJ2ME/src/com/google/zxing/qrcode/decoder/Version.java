...
public final class Version {
    ...
    /**
     * <p>Encapsulates a set of error-correction blocks in one symbol version.
     * Most versions will use blocks of differing sizes within one version, so,
     * this encapsulates the parameters for each set of blocks. It also holds
     * the number of error-correction codewords per block since it will be the
     * same across all blocks within one version.</p>
     */
    public static final class ECBlocks {
        ...
        ECBlocks(int ecCodewordsPerBlock, ECB ecBlocks1) {
            this.ecCodewordsPerBlock = ecCodewordsPerBlock;
            this.ecBlocks = new ECB[]{ecBlocks1};
        }
    ...
    /**
     * <p>Encapsualtes the parameters for one error-correction block in one
     * symbol version. This includes the number of data codewords, and the
     * number of times a block with these parameters is used consecutively in
     * the QR code version's format.</p>
     */
